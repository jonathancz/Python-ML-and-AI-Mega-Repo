...
'''
# We're going to run the test 30 times to get the best accuracy rate and
# then save that one
best = 0
for _ in range(30):
    ...
    # Only save the model for the best accuracy
    if accuracy > best:
        best = accuracy
        # Save a pickle file in our directory
...
# Select style for the plot
style.use("ggplot")

# The attribute as the x axis; the label is going to be on the y axis
p = 'G2'
# Scatter plot
